...
function Application.new()
    app = Gtk.Application {
        application_id = "com.github.jeysonflores.boxes"
    }
    ...
    function app:on_activate()
        ...
        if granite_settings.prefers_color_scheme == "DARK" then
            ...
            provider:load_from_path("/home/jeyson/Proyectos/Lua/Boxes/data/style-dark.css")
            Gtk.StyleContext.add_provider_for_screen(screen, provider, Gtk.STYLE_PROVIDER_PRIORITY_APPLICATION)
        else
            gtk_settings.gtk_application_prefer_dark_theme = false
            provider:load_from_path("/home/jeyson/Proyectos/Lua/Boxes/data/style.css")
            Gtk.StyleContext.add_provider_for_screen(screen, provider, Gtk.STYLE_PROVIDER_PRIORITY_APPLICATION)
        end
